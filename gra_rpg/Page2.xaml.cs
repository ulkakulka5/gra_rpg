...
/// @class Page2
/// @brief Scena ze skrzynią i zagadką.
/// @details Gracz może otworzyć skrzynię wpisując poprawny kod.
public partial class Page2 : ContentPage
{
    ...
    private void Content_PointerPressed(object? sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
    {
     ...
     /// @brief Obsługa kliknięcia skrzyni.
    /// @event Click
    /// @details Wyświetla panel wpisywania kodu.
    ...
    /// @brief Obsługa zmiany pierwszego pola kodu.
    ...
    /// @brief Obsługa zmiany drugiego pola kodu.
    ...
    /// @brief Obsługa trzeciego pola kodu.
    /// @details Sprawdza poprawność kodu (158).
    /// @async
    ...
    /// @brief Obsługa kliknięcia chleba (loot).
    /// @async

...
public partial class Page1 : ContentPage
{
 ...
 blockedAreas.Add(new Rect(993, 142, 237, 151));
    ...
    private void MoveCharacter(Image character, double newX, double newY, bool checkCollision)
    {
        ...
        if (!checkCollision || !IsBlocked(newX, newY, character.Width, character.Height))
        {
            character.TranslationX = newX;
            character.TranslationY = newY;
        }
    ...
    private bool IsBlocked(double x, double y, double width, double height)
    {
